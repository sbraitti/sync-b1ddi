...
def cliparser():
    ...
    parser.add_argument('-a', '--arecord', action="store_true", dest="arecord", help="Parse A record data")
    parser.add_argument('-t', '--txtrecord', action="store_true", dest="txtrecord", help="Parse TXT record data")
    parser.add_argument('-m', '--mxrecord', action="store_true", dest="mxrecord", help="Parse MX record data")
    parser.add_argument('--aaaa', action="store_true", dest="aaaarecord", help="Parse AAAA record data")
    parser.add_argument('--cname', action="store_true", dest="cnamerecord", help="Parse AAAA record data")
    parser.add_argument('--tags', action="store", dest="tags", help="Tags to apply to imported objects")
    parser.add_argument('--view', action="store", dest="viewname", help="Force view name", required=True)
